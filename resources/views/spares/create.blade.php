@extends('layouts.app')
@section('title', 'Nuevo Repuesto — Centro de Inventario')
...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb" style="font-size:.75rem;letter-spacing:.05em;text-transform:uppercase;font-weight:600;">
            ...
            <li class="breadcrumb-item active text-muted opacity-50" aria-current="page">Nuevo repuesto</li>
        </ol>
    </nav>

    <div class="mb-5">
        <h1 class="fw-bold mb-1" style="font-size:1.9rem;letter-spacing:-.02em;">
            <i class="bi bi-plus-circle-fill text-primary me-3"></i>Agregar Repuesto
        </h1>
        <p class="text-white text-opacity-50 mb-0">Registra un nuevo ítem en el inventario de la empresa.</p>
    </div>
        ...
        <form method="POST" action="{{ route('spares.store') }}">
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="code" name="code"
                               ...
                               value="{{ old('code') }}" placeholder="Ej: REP-001, FIL-HID-02" required>
                        @error('code')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        <div class="form-text text-muted">Debe ser único en el sistema.</div>
                    </div>
                    <div class="col-md-8">
                        ...
                        <input type="text" id="name" name="name"
                               ...
                               value="{{ old('name') }}" placeholder="Ej: Filtro hidráulico de alta presión" required>
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="description" name="description" rows="2"
                                  ...
                                  placeholder="Especificaciones técnicas, notas de uso, compatibilidad...">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-3">
                        <label for="stock" class="form-label small fw-bold text-muted">STOCK INICIAL <span class="text-danger">*</span></label>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="number" id="stock_min" name="stock_min" min="0"
                               ...
                               value="{{ old('stock_min', 5) }}" required>
                        @error('stock_min')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        <div class="form-text text-muted">Alerta si baja de este nivel.</div>
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="category" name="category" list="cat_list"
                               ...
                               value="{{ old('category') }}"
                               placeholder="Ej: Hidráulico, Eléctrico">
                        <datalist id="cat_list">
                            @foreach($categories as $cat)
                                <option value="{{ $cat }}">
                            @endforeach
                        </datalist>
                        <div class="form-text text-muted">Para clasificar y filtrar.</div>
                    </div>
                    <div class="col-md-4">
